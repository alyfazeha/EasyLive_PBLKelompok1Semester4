...
class EditKamarWidget {
  ...
  /* ===============================
     FOTO SLOT (KAMERA)
  =============================== */
  static Widget fotoSlot(int index, String? imagePath) {
    return Container(
      width: 65,
      height: 65,
      decoration: BoxDecoration(
  ...
  /* ===============================
     FOTO SLIDER (FOR GALLERY)
  =============================== */
  static Widget fotoSlider(List<String> images, Function(int) onRemove) {
    return SizedBox(
      height: 65,
  ...
  /* ===============================
     SECTION HEADER
  =============================== */
  static Widget sectionHeader(String title, {String? subtitle}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  /* ===============================
     PHOTO COUNTER
  =============================== */
  static Widget photoCounter(int current, int max) {
    return Text(
      "$current/$max Foto",
