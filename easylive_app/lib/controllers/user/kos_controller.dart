  ...
  static List<KostModel> getAllKost() {
    return [
      KostModel(
        ...
        address: "Lowokwaru",
        description:
            "Kost Daniska (khususnya Kost Daniska Lowokwaru, Malang) adalah hunian khusus putri yang menawarkan fasilitas kamar mandi dalam, WiFi, dan kasur dengan harga terjangkau sekitar Rp750.000 per bulan. Lokasinya berada di kawasan Lowokwaru, cocok untuk mahasiswa atau karyawan.",
        specifications: [
          "4 x 5 meter",
          "en-suite bathroom",
          "Air Conditioner",
