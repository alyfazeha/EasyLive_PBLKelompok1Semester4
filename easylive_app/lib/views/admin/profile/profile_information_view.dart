...
class _AdminProfileInformationViewState
  ...
  final _emailController =
      TextEditingController(text: 'admin@easyjasa.com');
  ...
  Future<void> _pickProfilePhoto(ImageSource source) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Gagal memilih foto profile'),
        ),
      );
    }
  }
  ...
  Future<void> _onSaveChanges() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          hasPhoto ? 'Profil berhasil diperbarui (foto profile diperbarui)' : 'Profil berhasil diperbarui',
        ),
      ),
    );
  }
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            _ProfileField(
                              ...
                              validator: (v) {
                                final value = (v ?? '').trim();
                                if (value.isEmpty) return 'Address wajib diisi';
                                return null;
                              },
                            ),
                            const SizedBox(height: 12),
